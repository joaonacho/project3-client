	...
	const LinksNavBar = ({ className }) => {
		return (
			<ul className={className}>
				<li>
					<NavLink className="navlink" onClick={() => setClick(false)} to="/explore">
						<p>explore movies</p>
					</NavLink>
				</li>
				...
				{isLoggedIn && (
					<>
						<li>
							<NavLink to="/find-friends" onClick={() => setClick(false)} className="navlink">
								<p>find friends</p>
							</NavLink>
						</li>
				...
				{!isLoggedIn && (
					<>
						<li>
							<NavLink to="/login" onClick={() => setClick(false)} className="navlink">
								Log in
							</NavLink>
						</li>
						<li>
							<NavLink to="/signup" onClick={() => setClick(false)} className="navlink">
								Sign Up
							</NavLink>
						</li>
					</>
